...
class NativeLibraryMethods {
    ...
    static native void koi3drenderer_addKoi(int i, String str, int i2);

    static native void koi3drenderer_init();

    static native void koi3drenderer_removeKoi(int i);

    static native void koi3drenderer_updateKoi(int i, String str, int i2);
    ...
    static native void scenefborenderer_init();

    static native void scenefborenderer_render(float f);

    static native void scenefborenderer_setPlantsVisible(boolean z);

    static native void scenefborenderer_setSchoolVisible(boolean z);
    ...
    static native void texturemanager_init(AssetManager assetManager, Context context);
