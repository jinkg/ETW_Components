...
public final class GLLimit {
    ...
    public final String gpuRenderer = Gdx.gl20.glGetString(GL20.GL_RENDERER);
    public final String gpuVendor = Gdx.gl20.glGetString(GL20.GL_VENDOR);
    ...
    public boolean isGCSeries() {
        if (this.gpuVendor.equals("Vivante Corporation") && this.gpuRenderer.contains("GC")) {
            return true;
        }
        return false;
    }
