...
public class TextureUtils {
    static Bitmap m20005a(InputStream inputStream, int i, int i2, int i3) {
        int height;
        try {
            int i4;
            ...
            for (StackTraceElement stackTraceElement : e.getStackTrace()) {
                Log.e("XMOD++", stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + " " + stackTraceElement.getMethodName());
            }
            return null;
        }
    }
