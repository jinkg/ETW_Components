...
public abstract class LibdgxWallpaperService extends WallpaperServiceProxy {
    private boolean DEBUG = false;
    private LibdgxWallpaperEngine previousEngine;

    public LibdgxWallpaperService(Context host) {
        super(host);
    }

    public abstract class LibdgxWallpaperEngine extends ActiveEngine {
