...
//		long timeStamp = event.getEventTime() * 1000000;
		...
		synchronized (input) { // FUCK
			...
			case MotionEvent.ACTION_POINTER_DOWN:
				...
				postTouchEvent(input, AndroidInput.TouchEvent.TOUCH_DOWN, x, y, realPointerIndex, timeStamp);
			...
			case MotionEvent.ACTION_CANCEL:
				...
				x = (int)event.getX(pointerIndex);
				y = (int)event.getY(pointerIndex);
				postTouchEvent(input, AndroidInput.TouchEvent.TOUCH_UP, x, y, realPointerIndex, timeStamp);
				input.touchX[realPointerIndex] = x;
				input.touchY[realPointerIndex] = y;
				input.deltaX[realPointerIndex] = 0;
				input.deltaY[realPointerIndex] = 0;
			...
			case MotionEvent.ACTION_MOVE:
				...
				for (int i = 0; i < pointerCount; i++) {
					...
					postTouchEvent(input, AndroidInput.TouchEvent.TOUCH_DRAGGED, x, y, realPointerIndex, timeStamp);
