...
public class Application {
    ...
    static class C06581 implements SignalHandlerString {
        C06581() {
        }
    ...
    public static synchronized void Init(Context context) {
        synchronized (Application.class) {
            ...
            Signals.RegisterHandler("toast", new C06581());
        }
    }
...
//            throw new UnsatisfiedLinkError();
            ...
            try {
                ...
                try {
                    ...
                    for (String str3 : new String[]{"arm64-v8a", "armeabi-v7a", "armeabi", "x86_64", "x86", "mips64", "mips"}) {
